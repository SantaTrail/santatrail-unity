...
namespace StarterAssets
{
    ...
    public partial class StarterAssetsDeployMenu : ScriptableObject
    {
        ...
        // names in hierarchy
        private const string CinemachineCameraName = "PlayerFollowCamera";
        ...
        private static GameObject _cinemachineCamera;
        ...
        private static void CheckCameras(Transform targetParent, string prefabFolder)
        {
            ...
            GameObject vcam = GameObject.Find(CinemachineCameraName);

            if (!vcam)
            {
                if (TryLocatePrefab(CinemachineCameraName, new string[]{prefabFolder}, new[] { typeof(CinemachineCamera) }, out GameObject vcamPrefab, out string _))
                {
                    HandleInstantiatingPrefab(vcamPrefab, out vcam);
                    _cinemachineCamera = vcam;
                }
                else
                {
            ...
            CheckVirtualCameraFollowReference(target, _cinemachineCamera);
        }
